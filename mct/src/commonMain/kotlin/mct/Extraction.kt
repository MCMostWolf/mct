 ...
 */
@Serializable
sealed interface ExtractionGroup<T : Extraction> {
    val extractions: List<T>
    ...
    data class Datapack(
        val source: String,
        val path: String,
        override val extractions: List<Extraction.Datapack>,
    ) : ExtractionGroup<Extraction.Datapack>
    ...
    data class Region(
        ...
        val coord: Coord,
        override val extractions: List<Extraction.Region>,
    ) : ExtractionGroup<Extraction.Region>
}
...
sealed interface Extraction {
    ...
    @Serializable
    @SerialName("Datapack")
    sealed interface Datapack : Extraction {
        /**
...
/**
 * Represents a grouped collection of replacements to be applied back to a source.
 */
@Serializable
sealed interface ReplacementGroup<T : Replacement> {
    val replacements: List<T>
    ...
    data class Datapack(
        val source: String,
        val path: String,
        override val replacements: List<Replacement.Datapack>,
    ) : ReplacementGroup<Replacement.Datapack>
    ...
    data class Region(
        ...
        val kind: ChunkDataKind,
        val coord: Coord,
        override val replacements: List<Replacement.Region>,
    ) : ReplacementGroup<Replacement.Region>
}

/**
 * Represents a single modification to be performed on source pointer.
 */
@Serializable
sealed interface Replacement {
    ...
    @Serializable
    @SerialName("Datapack")
    sealed interface Datapack : Replacement {
        /**
